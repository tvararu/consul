...
describe "Users" do
  ...
  scenario "Create a level 3 user with email from scratch using remote census api" do
  ...
  scenario "Create a level 3 user without email from scratch using remote census api" do
    configure_remote_census_api(date_of_birth_path: "some.value")
    visit management_document_verifications_path
    fill_in "document_verification_document_number", with: "12345678Z"
    select_date "31-December-1980", from: "document_verification_date_of_birth"
