...
describe "Managed User" do
  ...
  context "Currently managed user" do
    ...
    scenario "User becomes verified as level two (pending email confirmation for level three) using remote census" do
    ...
    scenario "User is created with email as level three from scratch using remote census" do
      configure_remote_census_api(date_of_birth_path: "some.value")
      login_as_manager
    ...
    scenario "User is created without email as level three from scratch using remote census" do
      configure_remote_census_api(date_of_birth_path: "some.value")
      login_as_manager
