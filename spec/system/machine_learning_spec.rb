...
describe "Machine learning" do
  ...
  describe "Comments summary" do
    scenario "is not displayed for proposals if setting is not enabled" do
    ...
    scenario "is not displayed for budget investments if setting is not enabled" do
  ...
  describe "Related content" do
    ...
    scenario "is not displayed for budget investments if setting is enabled" do
  ...
  describe "Tags" do
    ...
    scenario "are not displayed for proposals if setting is not enabled" do
      visit proposal_path(proposal)
    ...
    scenario "are not displayed for budget investments if setting is not enabled" do
      visit budget_investment_path(budget, investment)
